...
class IBDatabaseReader
        {
            ...
            public static string TrimHTMLFile(string HTMLFile)
            {
                string file_content = HTMLFile;
                string trimmed_file;

                file_content = file_content.Replace("IB Questionbank", "Generated Paper");
                file_content = file_content.Replace("IB Documents Team", "Spreadsheet Master");
            ...
            public static class SearchQuestionBank
            {
                ...
                public static string CreateLink(string filename)
                {
                    ...
                    string URI = "http://140.143.240.119/QuestionBank/questionbank.ibo.org/en/teachers/00000/questionbanks/45-dp-chemistry/questions/";
                    Console.WriteLine(URI + html_file);
                    return URI + html_file;               
                }

                public static void SendMessage(string key_term)
                {
                    string file_content;
                    string trimmed_file;
